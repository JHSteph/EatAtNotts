...
class PendingPickUpDetailsAdapter(private val MyOrdersList:ArrayList<PendingItem>, private val listener: OnItemClickListener): RecyclerView.Adapter<PendingPickUpDetailsAdapter.MyViewHolder>() {//Adapter to show RecyclerView for Pending Pick Up Order Details
