...
class PickUpDetailsAdapter(private val CustomerOrdersList:ArrayList<CustomerOrderItem>, private val listener: OnItemClickListener): RecyclerView.Adapter<PickUpDetailsAdapter.MyViewHolder>() {//PickUpDetailsAdapter to Create a RecyclerView
